...
CREATE TABLE public.activities (
  ...
  territory_polygon GEOGRAPHY(POLYGON, 4326), -- PostGIS polygon
...
CREATE INDEX idx_activities_route_geometry ON public.activities USING GIST(route_geometry);
CREATE INDEX idx_activities_territory_polygon ON public.activities USING GIST(territory_polygon);
CREATE INDEX idx_territory_ownership_polygon ON public.territory_ownership USING GIST(territory_polygon);
