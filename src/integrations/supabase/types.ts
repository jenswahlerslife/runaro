...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      player_bases: {
        Row: {
          ...
          territory_size_km2: number | null
          user_id: string
        }
        Insert: {
          activity_id: string
        ...
        Relationships: [
          {
            foreignKeyName: "player_bases_activity_id_fkey"
            columns: ["activity_id"]
            isOneToOne: false
          ...
          {
            foreignKeyName: "player_bases_game_id_fkey"
            columns: ["game_id"]
            isOneToOne: false
          ...
          {
            foreignKeyName: "player_bases_user_id_fkey"
            columns: ["user_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
      ...
      user_territories: {
        ...
        Relationships: [
          {
            foreignKeyName: "user_territories_game_id_fkey"
            columns: ["game_id"]
            isOneToOne: false
            referencedRelation: "games"
            referencedColumns: ["id"]
    ...
    Functions: {
      ...
      can_create_league: {
        Args: { member_count?: number; user_uuid?: string }
        Returns: boolean
      }
      close_linestring: {
        Args: { ls: unknown }
      ...
      get_admin_pending_requests_count: {
        Args: { league_id: string }
        Returns: number
      }
      ...
      insert_user_activity_with_route: {
        Args: {
          ...
          p_is_base: boolean
          p_max_speed: number
          p_moving_time: number
          p_name: string
          p_points_earned: number
          p_polyline: string
          p_start_date: string
          p_strava_activity_id: number
          p_total_elevation_gain: number
          p_user_id: string
          p_wkt_route: string
        }
        Returns: undefined
      ...
      jsonb_points_to_linestring: {
        Args: { coords: Json }
        Returns: unknown
      }
      list_my_leagues_with_role: {
        Args: Record<PropertyKey, never>
        Returns: {
          created_at: string
          description: string
      ...
      set_player_base: {
        Args: { p_activity_id: string; p_game_id: string }
        Returns: Json
      }
      set_player_base_simple: {
        Args: { p_activity_id: string; p_game_id: string }
        Returns: Json
      }
      spheroid_in: {
      ...
      start_game: {
        Args:
          | { p_duration_days?: number; p_game_id: string }
          | { p_game_id: string }
        Returns: Json
      }
      text: {
