...
-- Recreate with the exact arg NAMES that the client passes
...
BEGIN
  ...
  -- Create league with invite code and admin_user_id
...
SELECT 'Recreated function with exact parameter signature for PostgREST' as status;