-- Fix set_player_base function to recalculate territory after base selection
...
BEGIN
  ...
  -- Calculate territory for the player after setting base
  PERFORM public.calculate_player_territory(p_game_id, user_profile_id, 50);
