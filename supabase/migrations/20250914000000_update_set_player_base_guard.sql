-- Update set_player_base function to enforce 1-day rule
...
BEGIN
  ...
  -- Reject if activity is too old relative to game start/created (1-day rule)
  IF activity_record.start_date < (COALESCE(game_record.start_at, game_record.created_at) - interval '1 day') THEN
