...
DO $$ BEGIN
  IF EXISTS (
    ...
    WHERE schemaname = 'public'
      ...
      AND policyname = 'Users can join leagues'
  ) THEN
    DROP POLICY "Users can join leagues" ON public.league_memberships;
  END IF;
END $$;
...
DO $$ BEGIN
  IF EXISTS (
    ...
    DROP POLICY "Users can view their own memberships" ON public.league_memberships;
  END IF;
END $$;
