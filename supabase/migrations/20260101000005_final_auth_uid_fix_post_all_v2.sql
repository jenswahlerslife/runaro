-- FINAL POST-V2 FIX: Auth UID to Profile ID Mapping
-- This migration runs AFTER 20260101000004 to fix functions broken by v2
--
-- CRITICAL: Migration timestamps must be AFTER v2 (20260101000004) to take effect
