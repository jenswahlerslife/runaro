...
npx supabase --config infra/supabase/config.toml secrets set ^
...
npx supabase --config infra/supabase/config.toml functions deploy import-recent-activities --no-verify-jwt
